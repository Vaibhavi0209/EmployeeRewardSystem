            ...
            <div class="content-wrapper">
                <div class="card">
                    <div
                        ...
                        <h4 class="mb-0 text-white">Product Category</h4>

                        <button class="btn btn-primary" data-toggle="modal"
                                data-target="#productCategoryModal">Add
                        </button>
                            ...
                            <div class="col-12">
                                <div class="table-responsive">
                                    <table id="order-listing" class="table">
                                        ...
                                        <tbody>
                                        <c:forEach items="${productCategoryList}" var="i" varStatus="j">
                                            <tr>
                                                <td>${j.count}</td>
                                                <td>${i.category}</td>
                                                <td>${i.categoryDescription}</td>
                                                <td><a onclick="getCategoryById(${i.id})"
                                                       data-target="#productCategoryModal"><i
                                                        title="Edit Product Category"
                                                        data-toggle="modal"
                                                        data-target="#productCategoryModal"
                                                        class="mdi mdi-pencil lead" style="cursor: pointer"></i></a><a
                                                        href="deleteProductCategory?id=${i.id}"><i
    ...
    <div class="modal fade" id="productCategoryModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <f:form class="cmxform" id="category_form" method="post" action="saveProductCategory"
                        modelAttribute="productCategory1">
                    ...
                    <div class="modal-body">
                        <fieldset>
                            <div class="form-group">
                                <label class="required" for="category">Product Category Name</label> <f:input
                                    path="category"
                                    id="category"
                                    class="form-control" name="category"
                                    minlength="2" type="text" required="required"/>
                            </div>
                            <div class="form-group">
                                <label for="categoryDescription">Product Category Description </label>
                                <f:textarea path="categoryDescription" id="categoryDescription"
                                            class="form-control" name="categoryDescription"
                                            rows="5" minlength="2" maxlength="5000"></f:textarea>
                                <f:hidden path="id"/>
                            </div>
                        </fieldset>
                    </div>
...
<script src="<%=request.getContextPath()%>/adminResources/custom/js/category.js"></script>
