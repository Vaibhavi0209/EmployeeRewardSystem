            ...
            <div class="content-wrapper">
                <div class="card">
                    <div
                        ...
                        <h4 class="mb-0 text-white">City</h4>

                        <button class="btn btn-primary" data-toggle="modal"
                                data-target="#cityModal">Add
                        </button>
                                    ...
                                    <table id="order-listing" class="table">
                                        ...
                                        <c:forEach items="${cityList}" var="i" varStatus="j">
                                            <tr>
                                                ...
                                                <td>
                                                    <a onclick="getCityById(${i.id})"> <i data-toggle="modal"
                                                                                          data-target="#cityModal"
                                                                                          title="Edit City"
                                                                                          class="mdi mdi-pencil lead ml-2"></i>
                                                    </a>
                                                    <a href="cityDelete?id=${i.id}"> <i title="Delete City"
    ...
    <div class="modal fade" id="cityModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <f:form action="saveCity" method="post" modelAttribute="City" id="city_form">
                    <div class="modal-body">
                        <fieldset>

                            <div class="form-group">
                                <label class="required">State Name</label>
                                <f:select id="stateId" path="stateId.id" name="stateId" class="form-control" required="required">
                                    <option disabled="disabled" selected="selected">Select Sate</option>
                            ...
                            <div class="form-group"><label class="required" for="cityName">City Name</label>
                                <f:input path="cityName" id="cityName"
                                         class="form-control"
                                         name="cityName"
                                         minlength="2"
                                         type="text"/>
                            ...
                            <div class="form-group">
                                <label for="cityDescription">
                                    Description </label>
                                <f:textarea path="cityDescription" id="cityDescription" class="form-control"
                                            name="cityDescription" rows="5" maxlenght="500" />
                            </div>
...
<script src="<%=request.getContextPath()%>/adminResources/custom/js/city.js"></script>
